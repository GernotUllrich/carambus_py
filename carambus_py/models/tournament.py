...
class Tournament(models.Model):
    ...
    tournament_plan = models.ForeignKey('TournamentPlan', on_delete=models.CASCADE, related_name='tournaments_for_tournament_plan')
    ...
    tournament_monitor = models.OneToOneField('TournamentMonitor', on_delete=models.CASCADE, related_name='tournament_for_tournament_monitor')
    tournament_cc = models.OneToOneField('TournamentCc', on_delete=models.CASCADE, related_name='tournament_for_tournament_cc')
    ...
    tournament_local = models.OneToOneField('TournamentLocal', on_delete=models.CASCADE, related_name='tournament_for_tournament_local')
