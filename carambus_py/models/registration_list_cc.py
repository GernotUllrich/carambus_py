...
class RegistrationListCc(models.Model):
    ...
    branch_cc = models.ForeignKey('BranchCc', on_delete=models.CASCADE, related_name='registration_list_ccs_for_branch_cc')
    season = models.ForeignKey('Season', on_delete=models.CASCADE, related_name='registration_list_ccs_for_season')
    discipline = models.ForeignKey('Discipline', on_delete=models.CASCADE, related_name='registration_list_ccs_for_discipline')
    category_cc = models.ForeignKey('CategoryCc', on_delete=models.CASCADE, related_name='registration_list_ccs_for_category_cc')
