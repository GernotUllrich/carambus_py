...
class PartyCc(models.Model):
    ...
    league_cc = models.ForeignKey('carambus_py.LeagueCc', on_delete=models.CASCADE, related_name='party_ccs_for_league_cc')
    league_team_a_cc = models.ForeignKey('carambus_py.LeagueTeamCc', on_delete=models.CASCADE,
                                         related_name='party_ccs_for_league_team_a_cc')
    league_team_b_cc = models.ForeignKey('carambus_py.LeagueTeamCc', on_delete=models.CASCADE,
                                         related_name='party_ccs_for_league_team_b_cc')
    league_team_host_cc = models.ForeignKey('carambus_py.LeagueTeamCc', on_delete=models.CASCADE,
                                            related_name='party_ccs_for_league_team_host_cc')
    party = models.ForeignKey('carambus_py.Party', on_delete=models.CASCADE, related_name='party_cc_for_party')
