...
class PartyCc(models.Model):
    ...
    league_team_a_cc = models.ForeignKey('LeagueTeamCc', on_delete=models.CASCADE, related_name='party_ccs_for_league_team_a_cc')
    league_team_b_cc = models.ForeignKey('LeagueTeamCc', on_delete=models.CASCADE, related_name='party_ccs_for_league_team_b_cc')
    league_team_host_cc = models.ForeignKey('LeagueTeamCc', on_delete=models.CASCADE, related_name='party_ccs_for_league_team_host_cc')
