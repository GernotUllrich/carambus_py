...
class Game(models.Model):
    ...
    table_monitor = models.OneToOneField('TableMonitor', on_delete=models.CASCADE, related_name='game_for_table_monitor')
    was_table_monitor = models.OneToOneField('TableMonitor', on_delete=models.CASCADE, related_name='game_for_was_tournament')
