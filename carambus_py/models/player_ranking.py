...
class PlayerRanking(models.Model):
    ...
    discipline = models.ForeignKey('Discipline', on_delete=models.CASCADE, related_name='player_rankings_for_discipline')
    ...
    player_class = models.ForeignKey('PlayerClass', on_delete=models.CASCADE, related_name='player_rankings_for_player_class')
    p_player_class = models.ForeignKey('PlayerClass', on_delete=models.CASCADE, related_name='player_rankings_for_p_player_class')
    pp_player_class = models.ForeignKey('PlayerClass', on_delete=models.CASCADE, related_name='player_rankings_for_pp_player_class')
