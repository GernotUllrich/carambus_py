...
class Party(models.Model):
    ...
    league_team_b = models.ForeignKey('LeagueTeam', on_delete=models.CASCADE, related_name='parties_for_league_for_league_team_b')
    host_league_team = models.ForeignKey('LeagueTeam', on_delete=models.CASCADE, related_name='parties_for_host_league_team')
    ...
    party_monitor = models.OneToOneField('PartyMonitor', on_delete=models.CASCADE, related_name='party_for_party_monitor')
